...
if(!args[0]) return message.channel.send('Bir link ve ad yazmalısın. `amx_emojiekle https://cdn.discordapp.com/emojis/601379275769118731.png amx_bot`');
if(!args[0].endsWith('.png')) return message.channel.send('Doğru bir link yazmalısın.');
if(!args[1]) return message.channel.send('Bir emoji adı yazmalısın. `amx_emojiekle https://cdn.discordapp.com/emojis/601379275769118731.png amx_bot`');
